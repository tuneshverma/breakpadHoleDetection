...
#         img = cv2.cvtColor(img_color, cv2.COLOR_BGR2GRAY)
        ...
        for i in range(0, portion_w):
            ...
            if array_sum<0:
                ...
                cv2.line(img, (edge,0), (edge, new_height), (0,255,255), 2)
                break  
        ...
        cv2.putText(img, str(DisHole_1), (holeCoorList[1][0]+30, holeCoorList[1][1]),\
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
        cv2.putText(img, str(DisHole_2), (holeCoorList[0][0]+30, holeCoorList[0][1]),\
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
        cv2.line(img, (holeCoorList[1][0],y+5), (edge, y+5), (0,255,255), 2)
        cv2.line(img, (holeCoorList[0][0],y), (edge, y), (0,255,255), 2)
...
if __name__=='__main__':
    ...
    Camera2Detection_im = camera2detection.detection(imagePath)
