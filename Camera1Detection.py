...
def Camera1Detection(inputImage, templateImage):
    ...
    for (startX, startY, endX, endY) in pick:
        ...
        drawn_img = creating_contour(box)
...
if __name__=='__main__':
    ...
    # inputImage = 'C:/Users/tunes/Maxerience/image_processing/inputImages/sample_images/4515_New/ok/a11.png'
    # templateImage = "C:/Users/tunes/Maxerience/image_processing/inputImages/real_data_p/NG/2_blur_re_crop.png"
    # outputPath = 'C:/Users/tunes/Maxerience/image_processing/inputImages/sample_images/4515_New/ok/a11_output.png'
    ...
    s_time = time.time()
    Camera1Detection_pick, Camera1Detection_im2 = Camera1Detection(inputImage, templateImage)
