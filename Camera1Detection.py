...
def Camera1Detection(inputImage, templateImage):
    ...
    pick = sorted(pick,key=lambda l:l[1])
    dia_l = []
    diameter_dict = {}
    holeNumber = 0
    for (startX, startY, endX, endY) in pick:
        ...
        dia_l.append(dia)
        diameter_dict[holeNumber] = dia
        cv2.putText(im2, str(holeNumber), (endX_new, endY_new),cv2.FONT_HERSHEY_SIMPLEX, 4, (0, 255, 0), 6)
    ...
    return pick, im2, dia_l, diameter_dict
